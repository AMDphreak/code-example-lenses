...
Canonical registry rows and expected tiers: link:../spec/implementations.json5[`spec/implementations.json5`].
...
See xref:ecosystem.adoc[ecosystem.md].

== Contributing

1. Add a row to `spec/implementations.json5`.
2. Mirror the row in link:https://github.com/dev-centr/code-lens/blob/main/implementations/REGISTRY.md[`implementations/REGISTRY.md`].
