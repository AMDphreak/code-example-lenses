...
Static examples in link:https://github.com/dev-centr/code-lens[code-lens] ship pre-aligned token data. *Real code* has no `slot` keys — you must infer which identifiers play which role, then generate four naming variants (didactic, schematic, contextual, role-labeled).
...
See link:https://github.com/dev-centr/code-lens/blob/main/extensions/vscode/README.md[extensions/vscode/README.md].
...
See link:https://github.com/dev-centr/code-lens/blob/main/extensions/zed/README.md[extensions/zed/README.md].
...
* link:https://docs.devcentr.org/DevCentr/latest/todo-roadmap.html[DevCentr Todo & Roadmap — code-lens IDE]
* Upstream spec: link:https://github.com/dev-centr/code-lens[github.com/dev-centr/code-lens]
